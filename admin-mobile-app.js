(function adminAppBootstrap() {
  var APP_NAME = "MatrixMarket Admin";
  var APP_ICON = "admin.png";
  var MANIFEST_HREF = "admin-app.webmanifest";
  var DISMISS_KEY = "mmAdminInstallPromptDismissedAt";
  var DISMISS_MS = 3 * 24 * 60 * 60 * 1000;
  var PROMPT_ID = "mmAdminInstallPrompt";
  var STYLE_ID = "mmAdminInstallPromptStyles";
  ...
  function promptMessage() {
    if (deferredPrompt) {
      return {
        ...
        body: "Add the admin workspace to your device for faster access to dashboards, orders, payments, and users.",
        primary: "Install",
        secondary: "Later"
      };
    }
    return {
      title: "Add Admin App To Home Screen",
      body: "On iPhone, tap Share in Safari, then choose Add to Home Screen to install the admin app.",
      primary: "Got It",
      secondary: "Later"
    };
  }
